	...
	return (
		<div>
			...
			<div className="mb-20 mt-12 lg:grid lg:grid-cols-2 lg:gap-8">
				{projects.map(({ id, name, description, tech, link, github }) => {
					return (
						<div
							className="custom-shadow my-8 rounded-2xl border p-6 transition-shadow duration-300 dark:border-gray-500/50 lg:my-0"
							key={id}
						>
